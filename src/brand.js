export const brand = {
  name: "Doclira",
  product: "Doclira PDF",
  tagline: "One purchase. No subscription. Your files stay on your computer.",
  platform: "Windows 10 / 11 (64-bit)",
  price: "$29",
  purchaseUrl: "https://taixianglumark.gumroad.com/l/doclira-pdf",
  aiCreditsUrl: "https://taixianglumark.gumroad.com/l/ipkbe",
  installerUrl: "https://github.com/lienowen/doclira-website/releases/download/v1.0.6/DocliraPDF_Setup_v1.0.6_Windows_x64_EN.exe",
